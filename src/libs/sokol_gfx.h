...
struct _sg_state_t;
typedef struct _sg_state_t _sg_state_t;

// setup and misc functions
SOKOL_GFX_API_DECL _sg_state_t* sg_setup(const sg_desc* desc);
SOKOL_GFX_API_DECL void sg_shutdown(_sg_state_t* _sg);
SOKOL_GFX_API_DECL bool sg_isvalid(_sg_state_t* _sg);
SOKOL_GFX_API_DECL void sg_reset_state_cache(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_trace_hooks sg_install_trace_hooks(_sg_state_t* _sg, const sg_trace_hooks* trace_hooks);
SOKOL_GFX_API_DECL void sg_push_debug_group(_sg_state_t* _sg, const char* name);
SOKOL_GFX_API_DECL void sg_pop_debug_group(_sg_state_t* _sg);
SOKOL_GFX_API_DECL bool sg_add_commit_listener(_sg_state_t* _sg, sg_commit_listener listener);
SOKOL_GFX_API_DECL bool sg_remove_commit_listener(_sg_state_t* _sg, sg_commit_listener listener);

// resource creation, destruction and updating
SOKOL_GFX_API_DECL sg_buffer sg_make_buffer(_sg_state_t* _sg, const sg_buffer_desc* desc);
SOKOL_GFX_API_DECL sg_image sg_make_image(_sg_state_t* _sg, const sg_image_desc* desc);
SOKOL_GFX_API_DECL sg_sampler sg_make_sampler(_sg_state_t* _sg, const sg_sampler_desc* desc);
SOKOL_GFX_API_DECL sg_shader sg_make_shader(_sg_state_t* _sg, const sg_shader_desc* desc);
SOKOL_GFX_API_DECL sg_pipeline sg_make_pipeline(_sg_state_t* _sg, const sg_pipeline_desc* desc);
SOKOL_GFX_API_DECL sg_attachments sg_make_attachments(_sg_state_t* _sg, const sg_attachments_desc* desc);
SOKOL_GFX_API_DECL void sg_destroy_buffer(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL void sg_destroy_image(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL void sg_destroy_sampler(_sg_state_t* _sg, sg_sampler smp);
SOKOL_GFX_API_DECL void sg_destroy_shader(_sg_state_t* _sg, sg_shader shd);
SOKOL_GFX_API_DECL void sg_destroy_pipeline(_sg_state_t* _sg, sg_pipeline pip);
SOKOL_GFX_API_DECL void sg_destroy_attachments(_sg_state_t* _sg, sg_attachments atts);
SOKOL_GFX_API_DECL void sg_update_buffer(_sg_state_t* _sg, sg_buffer buf, const sg_range* data);
SOKOL_GFX_API_DECL void sg_update_image(_sg_state_t* _sg, sg_image img, const sg_image_data* data);
SOKOL_GFX_API_DECL int sg_append_buffer(_sg_state_t* _sg, sg_buffer buf, const sg_range* data);
SOKOL_GFX_API_DECL bool sg_query_buffer_overflow(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL bool sg_query_buffer_will_overflow(_sg_state_t* _sg, sg_buffer buf, size_t size);

// rendering functions
SOKOL_GFX_API_DECL void sg_begin_pass(_sg_state_t* _sg, const sg_pass* pass);
SOKOL_GFX_API_DECL void sg_apply_viewport(_sg_state_t* _sg, int x, int y, int width, int height, bool origin_top_left);
SOKOL_GFX_API_DECL void sg_apply_viewportf(_sg_state_t* _sg, float x, float y, float width, float height, bool origin_top_left);
SOKOL_GFX_API_DECL void sg_apply_scissor_rect(_sg_state_t* _sg, int x, int y, int width, int height, bool origin_top_left);
SOKOL_GFX_API_DECL void sg_apply_scissor_rectf(_sg_state_t* _sg, float x, float y, float width, float height, bool origin_top_left);
SOKOL_GFX_API_DECL void sg_apply_pipeline(_sg_state_t* _sg, sg_pipeline pip);
SOKOL_GFX_API_DECL void sg_apply_bindings(_sg_state_t* _sg, const sg_bindings* bindings);
SOKOL_GFX_API_DECL void sg_apply_uniforms(_sg_state_t* _sg, int ub_slot, const sg_range* data);
SOKOL_GFX_API_DECL void sg_draw(_sg_state_t* _sg, int base_element, int num_elements, int num_instances);
SOKOL_GFX_API_DECL void sg_end_pass(_sg_state_t* _sg);
SOKOL_GFX_API_DECL void sg_commit(_sg_state_t* _sg);

// getting information
SOKOL_GFX_API_DECL sg_desc sg_query_desc(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_backend sg_query_backend(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_features sg_query_features(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_limits sg_query_limits(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_pixelformat_info sg_query_pixelformat(_sg_state_t* _sg, sg_pixel_format fmt);
SOKOL_GFX_API_DECL int sg_query_row_pitch(_sg_state_t* _sg, sg_pixel_format fmt, int width, int row_align_bytes);
SOKOL_GFX_API_DECL int sg_query_surface_pitch(_sg_state_t* _sg, sg_pixel_format fmt, int width, int height, int row_align_bytes);
// get current state of a resource (INITIAL, ALLOC, VALID, FAILED, INVALID)
SOKOL_GFX_API_DECL sg_resource_state sg_query_buffer_state(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL sg_resource_state sg_query_image_state(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL sg_resource_state sg_query_sampler_state(_sg_state_t* _sg, sg_sampler smp);
SOKOL_GFX_API_DECL sg_resource_state sg_query_shader_state(_sg_state_t* _sg, sg_shader shd);
SOKOL_GFX_API_DECL sg_resource_state sg_query_pipeline_state(_sg_state_t* _sg, sg_pipeline pip);
SOKOL_GFX_API_DECL sg_resource_state sg_query_attachments_state(_sg_state_t* _sg, sg_attachments atts);
// get runtime information about a resource
SOKOL_GFX_API_DECL sg_buffer_info sg_query_buffer_info(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL sg_image_info sg_query_image_info(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL sg_sampler_info sg_query_sampler_info(_sg_state_t* _sg, sg_sampler smp);
SOKOL_GFX_API_DECL sg_shader_info sg_query_shader_info(_sg_state_t* _sg, sg_shader shd);
SOKOL_GFX_API_DECL sg_pipeline_info sg_query_pipeline_info(_sg_state_t* _sg, sg_pipeline pip);
SOKOL_GFX_API_DECL sg_attachments_info sg_query_attachments_info(_sg_state_t* _sg, sg_attachments atts);
// get desc structs matching a specific resource (NOTE that not all creation attributes may be provided)
SOKOL_GFX_API_DECL sg_buffer_desc sg_query_buffer_desc(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL sg_image_desc sg_query_image_desc(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL sg_sampler_desc sg_query_sampler_desc(_sg_state_t* _sg, sg_sampler smp);
SOKOL_GFX_API_DECL sg_shader_desc sg_query_shader_desc(_sg_state_t* _sg, sg_shader shd);
SOKOL_GFX_API_DECL sg_pipeline_desc sg_query_pipeline_desc(_sg_state_t* _sg, sg_pipeline pip);
SOKOL_GFX_API_DECL sg_attachments_desc sg_query_attachments_desc(_sg_state_t* _sg, sg_attachments atts);
// get resource creation desc struct with their default values replaced
SOKOL_GFX_API_DECL sg_buffer_desc sg_query_buffer_defaults(_sg_state_t* _sg, const sg_buffer_desc* desc);
SOKOL_GFX_API_DECL sg_image_desc sg_query_image_defaults(_sg_state_t* _sg, const sg_image_desc* desc);
SOKOL_GFX_API_DECL sg_sampler_desc sg_query_sampler_defaults(_sg_state_t* _sg, const sg_sampler_desc* desc);
SOKOL_GFX_API_DECL sg_shader_desc sg_query_shader_defaults(_sg_state_t* _sg, const sg_shader_desc* desc);
SOKOL_GFX_API_DECL sg_pipeline_desc sg_query_pipeline_defaults(_sg_state_t* _sg, const sg_pipeline_desc* desc);
SOKOL_GFX_API_DECL sg_attachments_desc sg_query_attachments_defaults(_sg_state_t* _sg, const sg_attachments_desc* desc);
// assorted query functions
SOKOL_GFX_API_DECL size_t sg_query_buffer_size(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL sg_buffer_type sg_query_buffer_type(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL sg_usage sg_query_buffer_usage(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL sg_image_type sg_query_image_type(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL int sg_query_image_width(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL int sg_query_image_height(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL int sg_query_image_num_slices(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL int sg_query_image_num_mipmaps(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL sg_pixel_format sg_query_image_pixelformat(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL sg_usage sg_query_image_usage(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL int sg_query_image_sample_count(_sg_state_t* _sg, sg_image img);

// separate resource allocation and initialization (for async setup)
SOKOL_GFX_API_DECL sg_buffer sg_alloc_buffer(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_image sg_alloc_image(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_sampler sg_alloc_sampler(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_shader sg_alloc_shader(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_pipeline sg_alloc_pipeline(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_attachments sg_alloc_attachments(_sg_state_t* _sg);
SOKOL_GFX_API_DECL void sg_dealloc_buffer(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL void sg_dealloc_image(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL void sg_dealloc_sampler(_sg_state_t* _sg, sg_sampler smp);
SOKOL_GFX_API_DECL void sg_dealloc_shader(_sg_state_t* _sg, sg_shader shd);
SOKOL_GFX_API_DECL void sg_dealloc_pipeline(_sg_state_t* _sg, sg_pipeline pip);
SOKOL_GFX_API_DECL void sg_dealloc_attachments(_sg_state_t* _sg, sg_attachments attachments);
SOKOL_GFX_API_DECL void sg_init_buffer(_sg_state_t* _sg, sg_buffer buf, const sg_buffer_desc* desc);
SOKOL_GFX_API_DECL void sg_init_image(_sg_state_t* _sg, sg_image img, const sg_image_desc* desc);
SOKOL_GFX_API_DECL void sg_init_sampler(_sg_state_t* _sg, sg_sampler smg, const sg_sampler_desc* desc);
SOKOL_GFX_API_DECL void sg_init_shader(_sg_state_t* _sg, sg_shader shd, const sg_shader_desc* desc);
SOKOL_GFX_API_DECL void sg_init_pipeline(_sg_state_t* _sg, sg_pipeline pip, const sg_pipeline_desc* desc);
SOKOL_GFX_API_DECL void sg_init_attachments(_sg_state_t* _sg, sg_attachments attachments, const sg_attachments_desc* desc);
SOKOL_GFX_API_DECL void sg_uninit_buffer(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL void sg_uninit_image(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL void sg_uninit_sampler(_sg_state_t* _sg, sg_sampler smp);
SOKOL_GFX_API_DECL void sg_uninit_shader(_sg_state_t* _sg, sg_shader shd);
SOKOL_GFX_API_DECL void sg_uninit_pipeline(_sg_state_t* _sg, sg_pipeline pip);
SOKOL_GFX_API_DECL void sg_uninit_attachments(_sg_state_t* _sg, sg_attachments atts);
SOKOL_GFX_API_DECL void sg_fail_buffer(_sg_state_t* _sg, sg_buffer buf);
SOKOL_GFX_API_DECL void sg_fail_image(_sg_state_t* _sg, sg_image img);
SOKOL_GFX_API_DECL void sg_fail_sampler(_sg_state_t* _sg, sg_sampler smp);
SOKOL_GFX_API_DECL void sg_fail_shader(_sg_state_t* _sg, sg_shader shd);
SOKOL_GFX_API_DECL void sg_fail_pipeline(_sg_state_t* _sg, sg_pipeline pip);
SOKOL_GFX_API_DECL void sg_fail_attachments(_sg_state_t* _sg, sg_attachments atts);

// frame stats
SOKOL_GFX_API_DECL void sg_enable_frame_stats(_sg_state_t* _sg);
SOKOL_GFX_API_DECL void sg_disable_frame_stats(_sg_state_t* _sg);
SOKOL_GFX_API_DECL bool sg_frame_stats_enabled(_sg_state_t* _sg);
SOKOL_GFX_API_DECL sg_frame_stats sg_query_frame_stats(_sg_state_t* _sg);
...
SOKOL_GFX_API_DECL const void* sg_d3d11_device(_sg_state_t* _sg);
// D3D11: return ID3D11DeviceContext
SOKOL_GFX_API_DECL const void* sg_d3d11_device_context(_sg_state_t* _sg);
// D3D11: get internal buffer resource objects
SOKOL_GFX_API_DECL sg_d3d11_buffer_info sg_d3d11_query_buffer_info(_sg_state_t* _sg, sg_buffer buf);
// D3D11: get internal image resource objects
SOKOL_GFX_API_DECL sg_d3d11_image_info sg_d3d11_query_image_info(_sg_state_t* _sg, sg_image img);
// D3D11: get internal sampler resource objects
SOKOL_GFX_API_DECL sg_d3d11_sampler_info sg_d3d11_query_sampler_info(_sg_state_t* _sg, sg_sampler smp);
// D3D11: get internal shader resource objects
SOKOL_GFX_API_DECL sg_d3d11_shader_info sg_d3d11_query_shader_info(_sg_state_t* _sg, sg_shader shd);
// D3D11: get internal pipeline resource objects
SOKOL_GFX_API_DECL sg_d3d11_pipeline_info sg_d3d11_query_pipeline_info(_sg_state_t* _sg, sg_pipeline pip);
// D3D11: get internal pass resource objects
SOKOL_GFX_API_DECL sg_d3d11_attachments_info sg_d3d11_query_attachments_info(_sg_state_t* _sg, sg_attachments atts);

// Metal: return __bridge-casted MTLDevice
SOKOL_GFX_API_DECL const void* sg_mtl_device(_sg_state_t* _sg);
// Metal: return __bridge-casted MTLRenderCommandEncoder in current pass (or zero if outside pass)
SOKOL_GFX_API_DECL const void* sg_mtl_render_command_encoder(_sg_state_t* _sg);
// Metal: get internal __bridge-casted buffer resource objects
SOKOL_GFX_API_DECL sg_mtl_buffer_info sg_mtl_query_buffer_info(_sg_state_t* _sg, sg_buffer buf);
// Metal: get internal __bridge-casted image resource objects
SOKOL_GFX_API_DECL sg_mtl_image_info sg_mtl_query_image_info(_sg_state_t* _sg, sg_image img);
// Metal: get internal __bridge-casted sampler resource objects
SOKOL_GFX_API_DECL sg_mtl_sampler_info sg_mtl_query_sampler_info(_sg_state_t* _sg, sg_sampler smp);
// Metal: get internal __bridge-casted shader resource objects
SOKOL_GFX_API_DECL sg_mtl_shader_info sg_mtl_query_shader_info(_sg_state_t* _sg, sg_shader shd);
// Metal: get internal __bridge-casted pipeline resource objects
SOKOL_GFX_API_DECL sg_mtl_pipeline_info sg_mtl_query_pipeline_info(_sg_state_t* _sg, sg_pipeline pip);

// WebGPU: return WGPUDevice object
SOKOL_GFX_API_DECL const void* sg_wgpu_device(_sg_state_t* _sg);
// WebGPU: return WGPUQueue object
SOKOL_GFX_API_DECL const void* sg_wgpu_queue(_sg_state_t* _sg);
// WebGPU: return this frame's WGPUCommandEncoder
SOKOL_GFX_API_DECL const void* sg_wgpu_command_encoder(_sg_state_t* _sg);
// WebGPU: return WGPURenderPassEncoder of current pass
SOKOL_GFX_API_DECL const void* sg_wgpu_render_pass_encoder(_sg_state_t* _sg);
// WebGPU: get internal buffer resource objects
SOKOL_GFX_API_DECL sg_wgpu_buffer_info sg_wgpu_query_buffer_info(_sg_state_t* _sg, sg_buffer buf);
// WebGPU: get internal image resource objects
SOKOL_GFX_API_DECL sg_wgpu_image_info sg_wgpu_query_image_info(_sg_state_t* _sg, sg_image img);
// WebGPU: get internal sampler resource objects
SOKOL_GFX_API_DECL sg_wgpu_sampler_info sg_wgpu_query_sampler_info(_sg_state_t* _sg, sg_sampler smp);
// WebGPU: get internal shader resource objects
SOKOL_GFX_API_DECL sg_wgpu_shader_info sg_wgpu_query_shader_info(_sg_state_t* _sg, sg_shader shd);
// WebGPU: get internal pipeline resource objects
SOKOL_GFX_API_DECL sg_wgpu_pipeline_info sg_wgpu_query_pipeline_info(_sg_state_t* _sg, sg_pipeline pip);
// WebGPU: get internal pass resource objects
SOKOL_GFX_API_DECL sg_wgpu_attachments_info sg_wgpu_query_attachments_info(_sg_state_t* _sg, sg_attachments atts);

// GL: get internal buffer resource objects
SOKOL_GFX_API_DECL sg_gl_buffer_info sg_gl_query_buffer_info(_sg_state_t* _sg, sg_buffer buf);
// GL: get internal image resource objects
SOKOL_GFX_API_DECL sg_gl_image_info sg_gl_query_image_info(_sg_state_t* _sg, sg_image img);
// GL: get internal sampler resource objects
SOKOL_GFX_API_DECL sg_gl_sampler_info sg_gl_query_sampler_info(_sg_state_t* _sg, sg_sampler smp);
// GL: get internal shader resource objects
SOKOL_GFX_API_DECL sg_gl_shader_info sg_gl_query_shader_info(_sg_state_t* _sg, sg_shader shd);
// GL: get internal pass resource objects
SOKOL_GFX_API_DECL sg_gl_attachments_info sg_gl_query_attachments_info(_sg_state_t* _sg, sg_attachments atts);
...
_SOKOL_PRIVATE void _sg_init_pool(_sg_state_t* _sg, _sg_pool_t* pool, int num);
_SOKOL_PRIVATE void _sg_discard_pool(_sg_state_t* _sg, _sg_pool_t* pool);
...
_SOKOL_PRIVATE void* _sg_malloc_clear(_sg_state_t* _sg, size_t size);
_SOKOL_PRIVATE void _sg_free(_sg_state_t* _sg, void* ptr);
...
#define _SG_PANIC(code) _sg_log(_sg, SG_LOGITEM_ ##code, 0, 0, __LINE__)
#define _SG_ERROR(code) _sg_log(_sg, SG_LOGITEM_ ##code, 1, 0, __LINE__)
#define _SG_WARN(code) _sg_log(_sg, SG_LOGITEM_ ##code, 2, 0, __LINE__)
#define _SG_INFO(code) _sg_log(_sg, SG_LOGITEM_ ##code, 3, 0, __LINE__)
#define _SG_LOGMSG(code,msg) _sg_log(_sg, SG_LOGITEM_ ##code, 3, msg, __LINE__)
#define _SG_VALIDATE(cond,code) if (!(cond)){ _sg->validate_error = SG_LOGITEM_ ##code; _sg_log(_sg, SG_LOGITEM_ ##code, 1, 0, __LINE__); }

static void _sg_log(_sg_state_t* _sg, sg_log_item log_item, uint32_t log_level, const char* msg, uint32_t line_nr) {
...
_SOKOL_PRIVATE void* _sg_malloc(_sg_state_t* _sg, size_t size) {
    SOKOL_ASSERT(size > 0);
    void* ptr;
...
_SOKOL_PRIVATE bool _sg_is_valid_rendertarget_color_format(_sg_state_t* _sg, sg_pixel_format fmt) {
...
_SOKOL_PRIVATE bool _sg_is_valid_rendertarget_depth_format(_sg_state_t* _sg, sg_pixel_format fmt) {
    const int fmt_index = (int) fmt;
    SOKOL_ASSERT((fmt_index >= 0) && (fmt_index < _SG_PIXELFORMAT_NUM));
    return _sg->formats[fmt_index].render && _sg->formats[fmt_index].depth;
}
...
_SOKOL_PRIVATE void _sg_dummy_setup_backend(_sg_state_t* _sg, const sg_desc* desc) {
    SOKOL_ASSERT(desc);
    _SOKOL_UNUSED(desc);
...
_SOKOL_PRIVATE sg_resource_state _sg_dummy_create_attachments(_sg_attachments_t* atts, _sg_image_t** color_images, _sg_image_t** resolve_images, _sg_image_t* ds_img, const sg_attachments_desc* desc) {
    ...
    for (int i = 0; i < atts->cmn.num_colors; i++) {
        ...
        SOKOL_ASSERT(_sg_is_valid_rendertarget_color_format(_sg, color_images[i]->cmn.pixel_format));
    ...
    if (ds_desc->image.id != SG_INVALID_ID) {
        ...
        SOKOL_ASSERT(_sg_is_valid_rendertarget_depth_format(_sg, ds_img->cmn.pixel_format));
...
_SOKOL_PRIVATE GLuint _sg_gl_compile_shader(sg_shader_stage stage, const char* src) {
    ...
    if (!compile_status) {
        ...
        if (log_len > 0) {
            GLchar* log_buf = (GLchar*) _sg_malloc(_sg, (size_t)log_len);
...
_SOKOL_PRIVATE sg_resource_state _sg_gl_create_attachments(_sg_attachments_t* atts, _sg_image_t** color_images, _sg_image_t** resolve_images, _sg_image_t* ds_image, const sg_attachments_desc* desc) {
    ...
    if (ds_desc->image.id != SG_INVALID_ID) {
        ...
        SOKOL_ASSERT(_sg_is_valid_rendertarget_depth_format(_sg, ds_image->cmn.pixel_format));
...
_SOKOL_PRIVATE UINT _sg_d3d11_dxgi_fmt_caps(_sg_state_t* _sg, DXGI_FORMAT dxgi_fmt) {
...
_SOKOL_PRIVATE void _sg_d3d11_init_caps(_sg_state_t* _sg) {
    ...
    for (int fmt = (SG_PIXELFORMAT_NONE+1); fmt < _SG_PIXELFORMAT_NUM; fmt++) {
        const UINT srv_dxgi_fmt_caps = _sg_d3d11_dxgi_fmt_caps(_sg, _sg_d3d11_srv_pixel_format((sg_pixel_format)fmt));
        const UINT rtv_dxgi_fmt_caps = _sg_d3d11_dxgi_fmt_caps(_sg, _sg_d3d11_rtv_pixel_format((sg_pixel_format)fmt));
        const UINT dsv_dxgi_fmt_caps = _sg_d3d11_dxgi_fmt_caps(_sg, _sg_d3d11_dsv_pixel_format((sg_pixel_format)fmt));
...
_SOKOL_PRIVATE void _sg_d3d11_setup_backend(_sg_state_t* _sg, const sg_desc* desc) {
    ...
    _sg_d3d11_init_caps(_sg);
}

_SOKOL_PRIVATE void _sg_d3d11_discard_backend(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->d3d11.valid);
    _sg->d3d11.valid = false;
}

_SOKOL_PRIVATE void _sg_d3d11_clear_state(_sg_state_t* _sg) {
...
_SOKOL_PRIVATE sg_resource_state _sg_d3d11_create_buffer(_sg_state_t* _sg, _sg_buffer_t* buf, const sg_buffer_desc* desc) {
    SOKOL_ASSERT(buf && desc);
...
_SOKOL_PRIVATE void _sg_d3d11_fill_subres_data(_sg_state_t* _sg, const _sg_image_t* img, const sg_image_data* data) {
    const int num_faces = (img->cmn.type == SG_IMAGETYPE_CUBE) ? 6:1;
...
_SOKOL_PRIVATE sg_resource_state _sg_d3d11_create_image(_sg_state_t* _sg, _sg_image_t* img, const sg_image_desc* desc) {
    SOKOL_ASSERT(img && desc);
    ...
    if (!injected && (img->cmn.usage == SG_USAGE_IMMUTABLE) && !img->cmn.render_target) {
        _sg_d3d11_fill_subres_data(_sg, img, &desc->data);
...
_SOKOL_PRIVATE sg_resource_state _sg_d3d11_create_sampler(_sg_state_t* _sg, _sg_sampler_t* smp, const sg_sampler_desc* desc) {
    SOKOL_ASSERT(smp && desc);
...
_SOKOL_PRIVATE bool _sg_d3d11_load_d3dcompiler_dll(_sg_state_t* _sg) {
...
_SOKOL_PRIVATE ID3DBlob* _sg_d3d11_compile_shader(_sg_state_t* _sg, const sg_shader_function* shd_func) {
    if (!_sg_d3d11_load_d3dcompiler_dll(_sg)) {
        return NULL;
    }
...
_SOKOL_PRIVATE bool _sg_d3d11_ensure_hlsl_bindslot_ranges(_sg_state_t* _sg, const sg_shader_desc* desc) {
    SOKOL_ASSERT(desc);
    for (size_t i = 0; i < SG_MAX_UNIFORMBLOCK_BINDSLOTS; i++) {
...
_SOKOL_PRIVATE sg_resource_state _sg_d3d11_create_shader(_sg_state_t* _sg, _sg_shader_t* shd, const sg_shader_desc* desc) {
    SOKOL_ASSERT(shd && desc);
    ...
    if (!_sg_d3d11_ensure_hlsl_bindslot_ranges(_sg, desc)) {
        return SG_RESOURCESTATE_FAILED;
    }
    ...
    if (desc->vertex_func.bytecode.ptr && desc->fragment_func.bytecode.ptr) {
        ...
        vs_blob = _sg_d3d11_compile_shader(_sg, &desc->vertex_func);
        fs_blob = _sg_d3d11_compile_shader(_sg, &desc->fragment_func);
        if (vs_blob && fs_blob) {
    ...
    if (vs_ptr && fs_ptr && (vs_length > 0) && (fs_length > 0)) {
        ...
        if (vs_succeeded && fs_succeeded) {
            ...
            shd->d3d11.vs_blob = _sg_malloc(_sg, (size_t)vs_length);
...
_SOKOL_PRIVATE void _sg_d3d11_discard_shader(_sg_state_t* _sg, _sg_shader_t* shd) {
    SOKOL_ASSERT(shd);
    if (shd->d3d11.vs) {
    ...
    if (shd->d3d11.vs_blob) {
        _sg_free(_sg, shd->d3d11.vs_blob);
    }
    for (size_t i = 0; i < SG_MAX_UNIFORMBLOCK_BINDSLOTS; i++) {
...
_SOKOL_PRIVATE sg_resource_state _sg_d3d11_create_pipeline(_sg_state_t* _sg, _sg_pipeline_t* pip, _sg_shader_t* shd, const sg_pipeline_desc* desc) {
    SOKOL_ASSERT(pip && shd && desc);
    SOKOL_ASSERT(desc->shader.id == shd->slot.id);
...
_SOKOL_PRIVATE void _sg_d3d11_discard_pipeline(_sg_state_t* _sg, _sg_pipeline_t* pip) {
    SOKOL_ASSERT(pip);
...
_SOKOL_PRIVATE sg_resource_state _sg_d3d11_create_attachments(_sg_state_t* _sg, _sg_attachments_t* atts, _sg_image_t** color_images, _sg_image_t** resolve_images, _sg_image_t* ds_img, const sg_attachments_desc* desc) {
    SOKOL_ASSERT(atts && desc);
    SOKOL_ASSERT(color_images && resolve_images);
...
_SOKOL_PRIVATE void _sg_d3d11_begin_pass(_sg_state_t* _sg, const sg_pass* pass) {
    SOKOL_ASSERT(pass);
...
_SOKOL_PRIVATE void _sg_d3d11_end_pass(_sg_state_t* _sg) {
    ...
    _sg->d3d11.cur_pipeline = 0;
    _sg->d3d11.cur_pipeline_id.id = SG_INVALID_ID;
    _sg_d3d11_clear_state(_sg);
}

_SOKOL_PRIVATE void _sg_d3d11_apply_viewport(_sg_state_t* _sg, int x, int y, int w, int h, bool origin_top_left) {
    SOKOL_ASSERT(_sg->d3d11.ctx);
    D3D11_VIEWPORT vp;
    vp.TopLeftX = (FLOAT) x;
...
_SOKOL_PRIVATE void _sg_d3d11_apply_scissor_rect(_sg_state_t* _sg, int x, int y, int w, int h, bool origin_top_left) {
    SOKOL_ASSERT(_sg->d3d11.ctx);
    D3D11_RECT rect;
    rect.left = x;
...
_SOKOL_PRIVATE void _sg_d3d11_apply_pipeline(_sg_state_t* _sg, _sg_pipeline_t* pip) {
    SOKOL_ASSERT(pip);
    SOKOL_ASSERT(pip->shader && (pip->cmn.shader_id.id == pip->shader->slot.id));
    SOKOL_ASSERT(_sg->d3d11.ctx);
...
_SOKOL_PRIVATE bool _sg_d3d11_apply_bindings(_sg_state_t* _sg, _sg_bindings_t* bnd) {
    SOKOL_ASSERT(bnd);
    SOKOL_ASSERT(bnd->pip && bnd->pip->shader);
    SOKOL_ASSERT(bnd->pip->shader->slot.id == bnd->pip->cmn.shader_id.id);
    SOKOL_ASSERT(_sg->d3d11.ctx);
...
_SOKOL_PRIVATE void _sg_d3d11_apply_uniforms(_sg_state_t* _sg, int ub_slot, const sg_range* data) {
    SOKOL_ASSERT(_sg->d3d11.ctx);
    SOKOL_ASSERT((ub_slot >= 0) && (ub_slot < SG_MAX_UNIFORMBLOCK_BINDSLOTS));
...
_SOKOL_PRIVATE void _sg_d3d11_draw(_sg_state_t* _sg, int base_element, int num_elements, int num_instances) {
...
_SOKOL_PRIVATE void _sg_d3d11_update_buffer(_sg_state_t* _sg, _sg_buffer_t* buf, const sg_range* data) {
    SOKOL_ASSERT(buf && data && data->ptr && (data->size > 0));
    SOKOL_ASSERT(_sg->d3d11.ctx);
    SOKOL_ASSERT(buf->d3d11.buf);
...
_SOKOL_PRIVATE void _sg_d3d11_append_buffer(_sg_state_t* _sg, _sg_buffer_t* buf, const sg_range* data, bool new_frame) {
    SOKOL_ASSERT(buf && data && data->ptr && (data->size > 0));
    SOKOL_ASSERT(_sg->d3d11.ctx);
    SOKOL_ASSERT(buf->d3d11.buf);
...
_SOKOL_PRIVATE void _sg_d3d11_update_image(_sg_state_t* _sg, _sg_image_t* img, const sg_image_data* data) {
    SOKOL_ASSERT(img && data);
    SOKOL_ASSERT(_sg->d3d11.ctx);
...
_SOKOL_PRIVATE void _sg_mtl_init_pool(const sg_desc* desc) {
    ...
    _sg->mtl.idpool.free_queue = (int*)_sg_malloc_clear(_sg, (size_t)_sg->mtl.idpool.num_slots * sizeof(int));
    ...
    _sg->mtl.idpool.release_queue = (_sg_mtl_release_item_t*)_sg_malloc_clear(_sg, (size_t)_sg->mtl.idpool.num_slots * sizeof(_sg_mtl_release_item_t));
    for (int i = 0; i < _sg->mtl.idpool.num_slots; i++) {
...
_SOKOL_PRIVATE void _sg_mtl_destroy_pool(void) {
    _sg_free(_sg, _sg->mtl.idpool.release_queue);  _sg->mtl.idpool.release_queue = 0;
    _sg_free(_sg, _sg->mtl.idpool.free_queue);     _sg->mtl.idpool.free_queue = 0;
...
_SOKOL_PRIVATE void _sg_wgpu_uniform_buffer_init(const sg_desc* desc) {
    ...
    _sg->wgpu.uniform.staging = (uint8_t*)_sg_malloc(_sg, _sg->wgpu.uniform.num_bytes);
...
_SOKOL_PRIVATE void _sg_wgpu_uniform_buffer_discard(void) {
    ...
    if (_sg->wgpu.uniform.staging) {
        _sg_free(_sg, _sg->wgpu.uniform.staging);
...
_SOKOL_PRIVATE void _sg_wgpu_bindgroups_pool_init(const sg_desc* desc) {
    ...
    p->bindgroups = (_sg_wgpu_bindgroup_t*) _sg_malloc_clear(_sg, pool_byte_size);
}

_SOKOL_PRIVATE void _sg_wgpu_bindgroups_pool_discard(void) {
    _sg_wgpu_bindgroups_pool_t* p = &_sg->wgpu.bindgroups_pool;
    SOKOL_ASSERT(p->bindgroups);
    _sg_free(_sg, p->bindgroups); p->bindgroups = 0;
...
_SOKOL_PRIVATE void _sg_wgpu_bindgroups_cache_init(const sg_desc* desc) {
    ...
    _sg->wgpu.bindgroups_cache.items = (_sg_wgpu_bindgroup_handle_t*)_sg_malloc_clear(_sg, size_in_bytes);
}

_SOKOL_PRIVATE void _sg_wgpu_bindgroups_cache_discard(void) {
    if (_sg->wgpu.bindgroups_cache.items) {
        _sg_free(_sg, _sg->wgpu.bindgroups_cache.items);
...
//
// >>generic backend
static inline void _sg_setup_backend(_sg_state_t* _sg, const sg_desc* desc) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_setup_backend(_sg, desc);
    #elif defined(SOKOL_METAL)
    _sg_mtl_setup_backend(_sg, desc);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_setup_backend(_sg, desc);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_setup_backend(_sg, desc);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_setup_backend(_sg, desc);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_discard_backend(_sg_state_t* _sg) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_discard_backend(_sg);
    #elif defined(SOKOL_METAL)
    _sg_mtl_discard_backend(_sg);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_discard_backend(_sg);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_discard_backend(_sg);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_discard_backend(_sg);
    #else
    #error("INVALID BACKEND");
    #endif
}
...
static inline sg_resource_state _sg_create_buffer(_sg_state_t* _sg, _sg_buffer_t* buf, const sg_buffer_desc* desc) {
    #if defined(_SOKOL_ANY_GL)
    return _sg_gl_create_buffer(_sg, buf, desc);
    #elif defined(SOKOL_METAL)
    return _sg_mtl_create_buffer(_sg, buf, desc);
    #elif defined(SOKOL_D3D11)
    return _sg_d3d11_create_buffer(_sg, buf, desc);
    #elif defined(SOKOL_WGPU)
    return _sg_wgpu_create_buffer(_sg, buf, desc);
    #elif defined(SOKOL_DUMMY_BACKEND)
    return _sg_dummy_create_buffer(_sg, buf, desc);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_discard_buffer(_sg_state_t* _sg, _sg_buffer_t* buf) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_discard_buffer(buf);
    #elif defined(SOKOL_METAL)
    _sg_mtl_discard_buffer(_sg, buf);
    #elif defined(SOKOL_D3D11)
...
static inline sg_resource_state _sg_create_image(_sg_state_t* _sg, _sg_image_t* img, const sg_image_desc* desc) {
    #if defined(_SOKOL_ANY_GL)
    return _sg_gl_create_image(_sg, img, desc);
    #elif defined(SOKOL_METAL)
    return _sg_mtl_create_image(_sg, img, desc);
    #elif defined(SOKOL_D3D11)
    return _sg_d3d11_create_image(_sg, img, desc);
    #elif defined(SOKOL_WGPU)
    return _sg_wgpu_create_image(_sg, img, desc);
    #elif defined(SOKOL_DUMMY_BACKEND)
    return _sg_dummy_create_image(_sg, img, desc);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_discard_image(_sg_state_t* _sg, _sg_image_t* img) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_discard_image(_sg, img);
    #elif defined(SOKOL_METAL)
    _sg_mtl_discard_image(_sg, img);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_discard_image(img);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_discard_image(_sg, img);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_discard_image(_sg, img);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline sg_resource_state _sg_create_sampler(_sg_state_t* _sg, _sg_sampler_t* smp, const sg_sampler_desc* desc) {
    #if defined(_SOKOL_ANY_GL)
    return _sg_gl_create_sampler(_sg, smp, desc);
    #elif defined(SOKOL_METAL)
    return _sg_mtl_create_sampler(_sg, smp, desc);
    #elif defined(SOKOL_D3D11)
    return _sg_d3d11_create_sampler(_sg, smp, desc);
    #elif defined(SOKOL_WGPU)
    return _sg_wgpu_create_sampler(_sg, smp, desc);
    #elif defined(SOKOL_DUMMY_BACKEND)
    return _sg_dummy_create_sampler(_sg, smp, desc);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_discard_sampler(_sg_state_t* _sg, _sg_sampler_t* smp) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_discard_sampler(_sg, smp);
    #elif defined(SOKOL_METAL)
    _sg_mtl_discard_sampler(_sg, smp);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_discard_sampler(smp);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_discard_sampler(_sg, smp);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_discard_sampler(_sg, smp);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline sg_resource_state _sg_create_shader(_sg_state_t* _sg, _sg_shader_t* shd, const sg_shader_desc* desc) {
    #if defined(_SOKOL_ANY_GL)
    return _sg_gl_create_shader(_sg, shd, desc);
    #elif defined(SOKOL_METAL)
    return _sg_mtl_create_shader(_sg, shd, desc);
    #elif defined(SOKOL_D3D11)
    return _sg_d3d11_create_shader(_sg, shd, desc);
    #elif defined(SOKOL_WGPU)
    return _sg_wgpu_create_shader(_sg, shd, desc);
    #elif defined(SOKOL_DUMMY_BACKEND)
    return _sg_dummy_create_shader(_sg, shd, desc);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_discard_shader(_sg_state_t* _sg, _sg_shader_t* shd) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_discard_shader(_sg, shd);
    #elif defined(SOKOL_METAL)
    _sg_mtl_discard_shader(_sg, shd);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_discard_shader(_sg, shd);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_discard_shader(_sg, shd);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_discard_shader(_sg, shd);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline sg_resource_state _sg_create_pipeline(_sg_state_t* _sg, _sg_pipeline_t* pip, _sg_shader_t* shd, const sg_pipeline_desc* desc) {
    #if defined(_SOKOL_ANY_GL)
    return _sg_gl_create_pipeline(_sg, pip, shd, desc);
    #elif defined(SOKOL_METAL)
    return _sg_mtl_create_pipeline(_sg, pip, shd, desc);
    #elif defined(SOKOL_D3D11)
    return _sg_d3d11_create_pipeline(_sg, pip, shd, desc);
    #elif defined(SOKOL_WGPU)
    return _sg_wgpu_create_pipeline(_sg, pip, shd, desc);
    #elif defined(SOKOL_DUMMY_BACKEND)
    return _sg_dummy_create_pipeline(_sg, pip, shd, desc);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_discard_pipeline(_sg_state_t* _sg, _sg_pipeline_t* pip) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_discard_pipeline(_sg, pip);
    #elif defined(SOKOL_METAL)
    _sg_mtl_discard_pipeline(_sg, pip);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_discard_pipeline(_sg, pip);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_discard_pipeline(_sg, pip);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_discard_pipeline(_sg, pip);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline sg_resource_state _sg_create_attachments(_sg_state_t* _sg, _sg_attachments_t* atts, _sg_image_t** color_images, _sg_image_t** resolve_images, _sg_image_t* ds_image, const sg_attachments_desc* desc) {
    #if defined(_SOKOL_ANY_GL)
    return _sg_gl_create_attachments(_sg, atts, color_images, resolve_images, ds_image, desc);
    #elif defined(SOKOL_METAL)
    return _sg_mtl_create_attachments(_sg, atts, color_images, resolve_images, ds_image, desc);
    #elif defined(SOKOL_D3D11)
    return _sg_d3d11_create_attachments(_sg, atts, color_images, resolve_images, ds_image, desc);
    #elif defined(SOKOL_WGPU)
    return _sg_wgpu_create_attachments(_sg, atts, color_images, resolve_images, ds_image, desc);
    #elif defined(SOKOL_DUMMY_BACKEND)
    return _sg_dummy_create_attachments(_sg, atts, color_images, resolve_images, ds_image, desc);
    #else
    #error("INVALID BACKEND");
    #endif
}
...
static inline void _sg_begin_pass(_sg_state_t* _sg, const sg_pass* pass) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_begin_pass(_sg, pass);
    #elif defined(SOKOL_METAL)
    _sg_mtl_begin_pass(_sg, pass);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_begin_pass(_sg, pass);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_begin_pass(_sg, pass);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_begin_pass(_sg, pass);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_end_pass(_sg_state_t* _sg) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_end_pass(_sg);
    #elif defined(SOKOL_METAL)
    _sg_mtl_end_pass(_sg);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_end_pass(_sg);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_end_pass(_sg);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_end_pass(_sg);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_apply_viewport(_sg_state_t* _sg, int x, int y, int w, int h, bool origin_top_left) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_apply_viewport(_sg, x, y, w, h, origin_top_left);
    #elif defined(SOKOL_METAL)
    _sg_mtl_apply_viewport(_sg, x, y, w, h, origin_top_left);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_apply_viewport(_sg, x, y, w, h, origin_top_left);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_apply_viewport(_sg, x, y, w, h, origin_top_left);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_apply_viewport(_sg, x, y, w, h, origin_top_left);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_apply_scissor_rect(_sg_state_t* _sg, int x, int y, int w, int h, bool origin_top_left) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_apply_scissor_rect(_sg, x, y, w, h, origin_top_left);
    #elif defined(SOKOL_METAL)
    _sg_mtl_apply_scissor_rect(_sg, x, y, w, h, origin_top_left);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_apply_scissor_rect(_sg, x, y, w, h, origin_top_left);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_apply_scissor_rect(_sg, x, y, w, h, origin_top_left);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_apply_scissor_rect(_sg, x, y, w, h, origin_top_left);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_apply_pipeline(_sg_state_t* _sg, _sg_pipeline_t* pip) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_apply_pipeline(_sg, pip);
    #elif defined(SOKOL_METAL)
    _sg_mtl_apply_pipeline(_sg, pip);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_apply_pipeline(_sg, pip);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_apply_pipeline(_sg, pip);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_apply_pipeline(_sg, pip);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline bool _sg_apply_bindings(_sg_state_t* _sg, _sg_bindings_t* bnd) {
    #if defined(_SOKOL_ANY_GL)
    return _sg_gl_apply_bindings(_sg, bnd);
    #elif defined(SOKOL_METAL)
    return _sg_mtl_apply_bindings(_sg, bnd);
    #elif defined(SOKOL_D3D11)
    return _sg_d3d11_apply_bindings(_sg, bnd);
    #elif defined(SOKOL_WGPU)
    return _sg_wgpu_apply_bindings(_sg, bnd);
    #elif defined(SOKOL_DUMMY_BACKEND)
    return _sg_dummy_apply_bindings(_sg, bnd);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_apply_uniforms(_sg_state_t* _sg, int ub_slot, const sg_range* data) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_apply_uniforms(_sg, ub_slot, data);
    #elif defined(SOKOL_METAL)
    _sg_mtl_apply_uniforms(_sg, ub_slot, data);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_apply_uniforms(_sg, ub_slot, data);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_apply_uniforms(_sg, ub_slot, data);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_apply_uniforms(_sg, ub_slot, data);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_draw(_sg_state_t* _sg, int base_element, int num_elements, int num_instances) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_draw(_sg, base_element, num_elements, num_instances);
    #elif defined(SOKOL_METAL)
    _sg_mtl_draw(_sg, base_element, num_elements, num_instances);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_draw(_sg, base_element, num_elements, num_instances);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_draw(_sg, base_element, num_elements, num_instances);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_draw(_sg, base_element, num_elements, num_instances);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_commit(_sg_state_t* _sg) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_commit();
    #elif defined(SOKOL_METAL)
    _sg_mtl_commit();
...
static inline void _sg_update_buffer(_sg_state_t* _sg, _sg_buffer_t* buf, const sg_range* data) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_update_buffer(_sg, buf, data);
    #elif defined(SOKOL_METAL)
    _sg_mtl_update_buffer(_sg, buf, data);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_update_buffer(_sg, buf, data);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_update_buffer(_sg, buf, data);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_update_buffer(_sg, buf, data);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_append_buffer(_sg_state_t* _sg, _sg_buffer_t* buf, const sg_range* data, bool new_frame) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_append_buffer(_sg, buf, data, new_frame);
    #elif defined(SOKOL_METAL)
    _sg_mtl_append_buffer(_sg, buf, data, new_frame);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_append_buffer(_sg, buf, data, new_frame);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_append_buffer(_sg, buf, data, new_frame);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_append_buffer(_sg, buf, data, new_frame);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_update_image(_sg_state_t* _sg, _sg_image_t* img, const sg_image_data* data) {
    #if defined(_SOKOL_ANY_GL)
    _sg_gl_update_image(_sg, img, data);
    #elif defined(SOKOL_METAL)
    _sg_mtl_update_image(_sg, img, data);
    #elif defined(SOKOL_D3D11)
    _sg_d3d11_update_image(_sg, img, data);
    #elif defined(SOKOL_WGPU)
    _sg_wgpu_update_image(_sg, img, data);
    #elif defined(SOKOL_DUMMY_BACKEND)
    _sg_dummy_update_image(_sg, img, data);
    #else
    #error("INVALID BACKEND");
    #endif
}

static inline void _sg_push_debug_group(_sg_state_t* _sg, const char* name) {
    #if defined(SOKOL_METAL)
    _sg_mtl_push_debug_group(_sg, name);
    #else
    _SOKOL_UNUSED(name);
    #endif
}

static inline void _sg_pop_debug_group(_sg_state_t* _sg) {
    #if defined(SOKOL_METAL)
    _sg_mtl_pop_debug_group(_sg);
    #endif
}
...
_SOKOL_PRIVATE void _sg_init_pool(_sg_state_t* _sg, _sg_pool_t* pool, int num) {
    ...
    pool->gen_ctrs = (uint32_t*)_sg_malloc_clear(_sg, gen_ctrs_size);
    // it's not a bug to only reserve 'num' here
    pool->free_queue = (int*) _sg_malloc_clear(_sg, sizeof(int) * (size_t)num);
...
_SOKOL_PRIVATE void _sg_discard_pool(_sg_state_t* _sg, _sg_pool_t* pool) {
    ...
    _sg_free(_sg, pool->free_queue);
    pool->free_queue = 0;
    SOKOL_ASSERT(pool->gen_ctrs);
    _sg_free(_sg, pool->gen_ctrs);
    pool->gen_ctrs = 0;
    pool->size = 0;
    pool->queue_top = 0;
}
...
_SOKOL_PRIVATE void _sg_setup_pools(_sg_state_t* _sg, _sg_pools_t* p, const sg_desc* desc) {
    SOKOL_ASSERT(p);
    SOKOL_ASSERT(desc);
    // note: the pools here will have an additional item, since slot 0 is reserved
    SOKOL_ASSERT((desc->buffer_pool_size > 0) && (desc->buffer_pool_size < _SG_MAX_POOL_SIZE));
    _sg_init_pool(_sg, &p->buffer_pool, desc->buffer_pool_size);
    size_t buffer_pool_byte_size = sizeof(_sg_buffer_t) * (size_t)p->buffer_pool.size;
    p->buffers = (_sg_buffer_t*) _sg_malloc_clear(_sg, buffer_pool_byte_size);

    SOKOL_ASSERT((desc->image_pool_size > 0) && (desc->image_pool_size < _SG_MAX_POOL_SIZE));
    _sg_init_pool(_sg, &p->image_pool, desc->image_pool_size);
    size_t image_pool_byte_size = sizeof(_sg_image_t) * (size_t)p->image_pool.size;
    p->images = (_sg_image_t*) _sg_malloc_clear(_sg, image_pool_byte_size);

    SOKOL_ASSERT((desc->sampler_pool_size > 0) && (desc->sampler_pool_size < _SG_MAX_POOL_SIZE));
    _sg_init_pool(_sg, &p->sampler_pool, desc->sampler_pool_size);
    size_t sampler_pool_byte_size = sizeof(_sg_sampler_t) * (size_t)p->sampler_pool.size;
    p->samplers = (_sg_sampler_t*) _sg_malloc_clear(_sg, sampler_pool_byte_size);

    SOKOL_ASSERT((desc->shader_pool_size > 0) && (desc->shader_pool_size < _SG_MAX_POOL_SIZE));
    _sg_init_pool(_sg, &p->shader_pool, desc->shader_pool_size);
    size_t shader_pool_byte_size = sizeof(_sg_shader_t) * (size_t)p->shader_pool.size;
    p->shaders = (_sg_shader_t*) _sg_malloc_clear(_sg, shader_pool_byte_size);

    SOKOL_ASSERT((desc->pipeline_pool_size > 0) && (desc->pipeline_pool_size < _SG_MAX_POOL_SIZE));
    _sg_init_pool(_sg, &p->pipeline_pool, desc->pipeline_pool_size);
    size_t pipeline_pool_byte_size = sizeof(_sg_pipeline_t) * (size_t)p->pipeline_pool.size;
    p->pipelines = (_sg_pipeline_t*) _sg_malloc_clear(_sg, pipeline_pool_byte_size);

    SOKOL_ASSERT((desc->attachments_pool_size > 0) && (desc->attachments_pool_size < _SG_MAX_POOL_SIZE));
    _sg_init_pool(_sg, &p->attachments_pool, desc->attachments_pool_size);
    size_t attachments_pool_byte_size = sizeof(_sg_attachments_t) * (size_t)p->attachments_pool.size;
    p->attachments = (_sg_attachments_t*) _sg_malloc_clear(_sg, attachments_pool_byte_size);
}

_SOKOL_PRIVATE void _sg_discard_pools(_sg_state_t* _sg, _sg_pools_t* p) {
    SOKOL_ASSERT(p);
    _sg_free(_sg, p->attachments); p->attachments = 0;
    _sg_free(_sg, p->pipelines);   p->pipelines = 0;
    _sg_free(_sg, p->shaders);     p->shaders = 0;
    _sg_free(_sg, p->samplers);    p->samplers = 0;
    _sg_free(_sg, p->images);      p->images = 0;
    _sg_free(_sg, p->buffers);     p->buffers = 0;
    _sg_discard_pool(_sg, &p->attachments_pool);
    _sg_discard_pool(_sg, &p->pipeline_pool);
    _sg_discard_pool(_sg, &p->shader_pool);
    _sg_discard_pool(_sg, &p->sampler_pool);
    _sg_discard_pool(_sg, &p->image_pool);
    _sg_discard_pool(_sg, &p->buffer_pool);
}
...
_SOKOL_PRIVATE void _sg_discard_all_resources(_sg_state_t* _sg, _sg_pools_t* p) {
...
// >>validation
#if defined(SOKOL_DEBUG)
_SOKOL_PRIVATE void _sg_validate_begin(_sg_state_t* _sg) {
    _sg->validate_error = SG_LOGITEM_OK;
}

_SOKOL_PRIVATE bool _sg_validate_end(_sg_state_t* _sg) {
...
_SOKOL_PRIVATE bool _sg_validate_buffer_desc(_sg_state_t* _sg, const sg_buffer_desc* desc) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(desc);
        return true;
    #else
        ...
        return _sg_validate_end(_sg);
    #endif
}

_SOKOL_PRIVATE void _sg_validate_image_data(_sg_state_t* _sg, const sg_image_data* data, sg_pixel_format fmt, int width, int height, int num_faces, int num_mips, int num_slices) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(data);
        _SOKOL_UNUSED(fmt);
        _SOKOL_UNUSED(width);
...
_SOKOL_PRIVATE bool _sg_validate_image_desc(_sg_state_t* _sg, const sg_image_desc* desc) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(desc);
        return true;
    #else
        ...
        if (desc->render_target) {
            ...
            const bool valid_nonrt_fmt = !_sg_is_valid_rendertarget_depth_format(_sg, fmt);
            ...
            if (!injected && is_immutable) {
                ...
                _sg_validate_image_data(_sg, &desc->data,
                    desc->pixel_format,
                    desc->width,
                    desc->height,
...
_SOKOL_PRIVATE bool _sg_validate_sampler_desc(_sg_state_t* _sg, const sg_sampler_desc* desc) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(desc);
        return true;
    #else
...
_SOKOL_PRIVATE bool _sg_validate_shader_desc(_sg_state_t* _sg, const sg_shader_desc* desc) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(desc);
        return true;
    #else
...
_SOKOL_PRIVATE bool _sg_validate_pipeline_desc(_sg_state_t* _sg, const sg_pipeline_desc* desc) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(desc);
        return true;
    #else
...
_SOKOL_PRIVATE bool _sg_validate_attachments_desc(_sg_state_t* _sg, const sg_attachments_desc* desc) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(desc);
        return true;
    #else
        ...
        for (int att_index = 0; att_index < SG_MAX_COLOR_ATTACHMENTS; att_index++) {
            ...
            if (0 != img) {
                ...
                _SG_VALIDATE(_sg_is_valid_rendertarget_color_format(_sg, img->cmn.pixel_format), VALIDATE_ATTACHMENTSDESC_COLOR_INV_PIXELFORMAT);
        ...
        if (desc->depth_stencil.image.id != SG_INVALID_ID) {
            ...
            if (img) {
                ...
                _SG_VALIDATE(_sg_is_valid_rendertarget_depth_format(_sg, img->cmn.pixel_format), VALIDATE_ATTACHMENTSDESC_DEPTH_INV_PIXELFORMAT);
            }
        }
...
_SOKOL_PRIVATE bool _sg_validate_begin_pass(_sg_state_t* _sg, const sg_pass* pass) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(pass);
        return true;
    #else
...
_SOKOL_PRIVATE bool _sg_validate_apply_pipeline(_sg_state_t* _sg, sg_pipeline pip_id) {
    #if !defined(SOKOL_DEBUG)
...
_SOKOL_PRIVATE bool _sg_validate_apply_bindings(_sg_state_t* _sg, const sg_bindings* bindings) {
    #if !defined(SOKOL_DEBUG)
...
_SOKOL_PRIVATE bool _sg_validate_apply_uniforms(_sg_state_t* _sg, int ub_slot, const sg_range* data) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(ub_slot);
        _SOKOL_UNUSED(data);
        return true;
...
_SOKOL_PRIVATE bool _sg_validate_update_buffer(_sg_state_t* _sg, const _sg_buffer_t* buf, const sg_range* data) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(buf);
        _SOKOL_UNUSED(data);
        return true;
...
_SOKOL_PRIVATE bool _sg_validate_append_buffer(_sg_state_t* _sg, const _sg_buffer_t* buf, const sg_range* data) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(buf);
        _SOKOL_UNUSED(data);
        return true;
...
_SOKOL_PRIVATE bool _sg_validate_update_image(_sg_state_t* _sg, const _sg_image_t* img, const sg_image_data* data) {
    #if !defined(SOKOL_DEBUG)
        _SOKOL_UNUSED(img);
        _SOKOL_UNUSED(data);
        return true;
        ...
        _sg_validate_image_data(_sg, data,
...
_SOKOL_PRIVATE sg_image_desc _sg_image_desc_defaults(_sg_state_t* _sg, const sg_image_desc* desc) {
...
_SOKOL_PRIVATE sg_pipeline_desc _sg_pipeline_desc_defaults(_sg_state_t* _sg, const sg_pipeline_desc* desc) {
...
_SOKOL_PRIVATE sg_buffer _sg_alloc_buffer(_sg_state_t* _sg) {
    sg_buffer res;
...
_SOKOL_PRIVATE sg_image _sg_alloc_image(_sg_state_t* _sg) {
    sg_image res;
...
_SOKOL_PRIVATE sg_sampler _sg_alloc_sampler(_sg_state_t* _sg) {
    sg_sampler res;
...
_SOKOL_PRIVATE sg_shader _sg_alloc_shader(_sg_state_t* _sg) {
    sg_shader res;
...
_SOKOL_PRIVATE sg_pipeline _sg_alloc_pipeline(_sg_state_t* _sg) {
    sg_pipeline res;
...
_SOKOL_PRIVATE sg_attachments _sg_alloc_attachments(_sg_state_t* _sg) {
    sg_attachments res;
...
_SOKOL_PRIVATE void _sg_dealloc_buffer(_sg_state_t* _sg, _sg_buffer_t* buf) {
...
_SOKOL_PRIVATE void _sg_dealloc_image(_sg_state_t* _sg, _sg_image_t* img) {
...
_SOKOL_PRIVATE void _sg_dealloc_sampler(_sg_state_t* _sg, _sg_sampler_t* smp) {
...
_SOKOL_PRIVATE void _sg_dealloc_shader(_sg_state_t* _sg, _sg_shader_t* shd) {
...
_SOKOL_PRIVATE void _sg_dealloc_pipeline(_sg_state_t* _sg, _sg_pipeline_t* pip) {
...
_SOKOL_PRIVATE void _sg_dealloc_attachments(_sg_state_t* _sg, _sg_attachments_t* atts) {
...
_SOKOL_PRIVATE void _sg_init_buffer(_sg_state_t* _sg,_sg_buffer_t* buf, const sg_buffer_desc* desc) {
    SOKOL_ASSERT(buf && (buf->slot.state == SG_RESOURCESTATE_ALLOC));
    SOKOL_ASSERT(desc);
    if (_sg_validate_buffer_desc(_sg, desc)) {
        _sg_buffer_common_init(&buf->cmn, desc);
        buf->slot.state = _sg_create_buffer(_sg, buf, desc);
    } else {
...
_SOKOL_PRIVATE void _sg_init_image(_sg_state_t* _sg, _sg_image_t* img, const sg_image_desc* desc) {
    SOKOL_ASSERT(img && (img->slot.state == SG_RESOURCESTATE_ALLOC));
    SOKOL_ASSERT(desc);
    if (_sg_validate_image_desc(_sg, desc)) {
        _sg_image_common_init(&img->cmn, desc);
        img->slot.state = _sg_create_image(_sg, img, desc);
    } else {
...
_SOKOL_PRIVATE void _sg_init_sampler(_sg_state_t* _sg, _sg_sampler_t* smp, const sg_sampler_desc* desc) {
    SOKOL_ASSERT(smp && (smp->slot.state == SG_RESOURCESTATE_ALLOC));
    SOKOL_ASSERT(desc);
    if (_sg_validate_sampler_desc(_sg, desc)) {
        _sg_sampler_common_init(&smp->cmn, desc);
        smp->slot.state = _sg_create_sampler(_sg, smp, desc);
    } else {
...
_SOKOL_PRIVATE void _sg_init_shader(_sg_state_t* _sg, _sg_shader_t* shd, const sg_shader_desc* desc) {
    SOKOL_ASSERT(shd && (shd->slot.state == SG_RESOURCESTATE_ALLOC));
    SOKOL_ASSERT(desc);
    if (_sg_validate_shader_desc(_sg, desc)) {
        _sg_shader_common_init(&shd->cmn, desc);
        shd->slot.state = _sg_create_shader(_sg, shd, desc);
    } else {
...
_SOKOL_PRIVATE void _sg_init_pipeline(_sg_state_t* _sg, _sg_pipeline_t* pip, const sg_pipeline_desc* desc) {
    SOKOL_ASSERT(pip && (pip->slot.state == SG_RESOURCESTATE_ALLOC));
    SOKOL_ASSERT(desc);
    if (_sg_validate_pipeline_desc(_sg, desc)) {
        ...
        if (shd && (shd->slot.state == SG_RESOURCESTATE_VALID)) {
            ...
            pip->slot.state = _sg_create_pipeline(_sg, pip, shd, desc);
        } else {
...
_SOKOL_PRIVATE void _sg_init_attachments(_sg_state_t* _sg, _sg_attachments_t* atts, const sg_attachments_desc* desc) {
    SOKOL_ASSERT(atts && atts->slot.state == SG_RESOURCESTATE_ALLOC);
    SOKOL_ASSERT(desc);
    if (_sg_validate_attachments_desc(_sg, desc)) {
        ...
        atts->slot.state = _sg_create_attachments(_sg, atts, color_images, resolve_images, ds_image, desc);
    } else {
        atts->slot.state = SG_RESOURCESTATE_FAILED;
    }
...
_SOKOL_PRIVATE void _sg_setup_commit_listeners(_sg_state_t* _sg, const sg_desc* desc) {
    ...
    _sg->commit_listeners.items = (sg_commit_listener*)_sg_malloc_clear(_sg, size);
}

_SOKOL_PRIVATE void _sg_discard_commit_listeners(_sg_state_t* _sg) {
    SOKOL_ASSERT(0 != _sg->commit_listeners.items);
    _sg_free(_sg, _sg->commit_listeners.items);
    _sg->commit_listeners.items = 0;
}

_SOKOL_PRIVATE void _sg_notify_commit_listeners(_sg_state_t* _sg) {
...
_SOKOL_PRIVATE bool _sg_add_commit_listener(_sg_state_t* _sg, const sg_commit_listener* new_listener) {
...
_SOKOL_PRIVATE bool _sg_remove_commit_listener(_sg_state_t* _sg, const sg_commit_listener* listener) {
...
_SOKOL_PRIVATE sg_pass _sg_pass_defaults(_sg_state_t* _sg, const sg_pass* pass) {
    sg_pass res = *pass;
...
//
// >>public
SOKOL_API_IMPL _sg_state_t* sg_setup(const sg_desc* desc) {
    SOKOL_ASSERT(desc);
    SOKOL_ASSERT((desc->_start_canary == 0) && (desc->_end_canary == 0));
    SOKOL_ASSERT((desc->allocator.alloc_fn && desc->allocator.free_fn) || (!desc->allocator.alloc_fn && !desc->allocator.free_fn));

    _sg_state_t* _sg = NULL;
    if (desc->allocator.alloc_fn)
        _sg = desc->allocator.alloc_fn(sizeof(*_sg), desc->allocator.user_data);
    else
        _sg = malloc(sizeof(*_sg));
    SOKOL_ASSERT(_sg);
    ...
    _sg_setup_pools(_sg, &_sg->pools, &_sg->desc);
    _sg_setup_commit_listeners(_sg, &_sg->desc);
    _sg->frame_index = 1;
    _sg->stats_enabled = true;
    _sg_setup_backend(_sg, &_sg->desc);
    _sg->valid = true;

    return _sg;
}

SOKOL_API_IMPL void sg_shutdown(_sg_state_t* _sg) {
    _sg_discard_all_resources(_sg, &_sg->pools);
    _sg_discard_backend(_sg);
    _sg_discard_commit_listeners(_sg);
    _sg_discard_pools(_sg, &_sg->pools);
    _SG_CLEAR_ARC_STRUCT(_sg_state_t, (*_sg));
...
SOKOL_API_IMPL bool sg_isvalid(_sg_state_t* _sg) {
    return _sg->valid;
}

SOKOL_API_IMPL sg_desc sg_query_desc(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    return _sg->desc;
}

SOKOL_API_IMPL sg_backend sg_query_backend(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    return _sg->backend;
}

SOKOL_API_IMPL sg_features sg_query_features(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    return _sg->features;
}

SOKOL_API_IMPL sg_limits sg_query_limits(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    return _sg->limits;
}

SOKOL_API_IMPL sg_pixelformat_info sg_query_pixelformat(_sg_state_t* _sg, sg_pixel_format fmt) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL int sg_query_row_pitch(_sg_state_t* _sg, sg_pixel_format fmt, int width, int row_align_bytes) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL int sg_query_surface_pitch(_sg_state_t* _sg, sg_pixel_format fmt, int width, int height, int row_align_bytes) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT((width > 0) && (height > 0));
    SOKOL_ASSERT((row_align_bytes > 0) && _sg_ispow2(row_align_bytes));
    SOKOL_ASSERT(((int)fmt > SG_PIXELFORMAT_NONE) && ((int)fmt < _SG_PIXELFORMAT_NUM));
...
SOKOL_API_IMPL sg_frame_stats sg_query_frame_stats(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    return _sg->prev_stats;
}

SOKOL_API_IMPL sg_trace_hooks sg_install_trace_hooks(_sg_state_t* _sg, const sg_trace_hooks* trace_hooks) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_buffer sg_alloc_buffer(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    sg_buffer res = _sg_alloc_buffer(_sg);
    _SG_TRACE_ARGS(alloc_buffer, res);
    return res;
}

SOKOL_API_IMPL sg_image sg_alloc_image(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    sg_image res = _sg_alloc_image(_sg);
    _SG_TRACE_ARGS(alloc_image, res);
    return res;
}

SOKOL_API_IMPL sg_sampler sg_alloc_sampler(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    sg_sampler res = _sg_alloc_sampler(_sg);
    _SG_TRACE_ARGS(alloc_sampler, res);
    return res;
}

SOKOL_API_IMPL sg_shader sg_alloc_shader(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    sg_shader res = _sg_alloc_shader(_sg);
    _SG_TRACE_ARGS(alloc_shader, res);
    return res;
}

SOKOL_API_IMPL sg_pipeline sg_alloc_pipeline(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    sg_pipeline res = _sg_alloc_pipeline(_sg);
    _SG_TRACE_ARGS(alloc_pipeline, res);
    return res;
}

SOKOL_API_IMPL sg_attachments sg_alloc_attachments(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    sg_attachments res = _sg_alloc_attachments(_sg);
    _SG_TRACE_ARGS(alloc_attachments, res);
    return res;
}

SOKOL_API_IMPL void sg_dealloc_buffer(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
    if (buf) {
        if (buf->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_dealloc_buffer(_sg, buf);
        } else {
...
SOKOL_API_IMPL void sg_dealloc_image(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
        if (img->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_dealloc_image(_sg, img);
        } else {
...
SOKOL_API_IMPL void sg_dealloc_sampler(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_sampler_t* smp = _sg_lookup_sampler(&_sg->pools, smp_id.id);
    if (smp) {
        if (smp->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_dealloc_sampler(_sg, smp);
        } else {
...
SOKOL_API_IMPL void sg_dealloc_shader(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_shader_t* shd = _sg_lookup_shader(&_sg->pools, shd_id.id);
    if (shd) {
        if (shd->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_dealloc_shader(_sg, shd);
        } else {
...
SOKOL_API_IMPL void sg_dealloc_pipeline(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_pipeline_t* pip = _sg_lookup_pipeline(&_sg->pools, pip_id.id);
    if (pip) {
        if (pip->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_dealloc_pipeline(_sg, pip);
        } else {
...
SOKOL_API_IMPL void sg_dealloc_attachments(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_attachments_t* atts = _sg_lookup_attachments(&_sg->pools, atts_id.id);
    if (atts) {
        if (atts->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_dealloc_attachments(_sg, atts);
        } else {
...
SOKOL_API_IMPL void sg_init_buffer(_sg_state_t* _sg, sg_buffer buf_id, const sg_buffer_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    sg_buffer_desc desc_def = _sg_buffer_desc_defaults(desc);
    _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
    if (buf) {
        if (buf->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_init_buffer(_sg, buf, &desc_def);
            SOKOL_ASSERT((buf->slot.state == SG_RESOURCESTATE_VALID) || (buf->slot.state == SG_RESOURCESTATE_FAILED));
        } else {
...
SOKOL_API_IMPL void sg_init_image(_sg_state_t* _sg, sg_image img_id, const sg_image_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    sg_image_desc desc_def = _sg_image_desc_defaults(_sg, desc);
    _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
        if (img->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_init_image(_sg, img, &desc_def);
            SOKOL_ASSERT((img->slot.state == SG_RESOURCESTATE_VALID) || (img->slot.state == SG_RESOURCESTATE_FAILED));
        } else {
...
SOKOL_API_IMPL void sg_init_sampler(_sg_state_t* _sg, sg_sampler smp_id, const sg_sampler_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    sg_sampler_desc desc_def = _sg_sampler_desc_defaults(desc);
    _sg_sampler_t* smp = _sg_lookup_sampler(&_sg->pools, smp_id.id);
    if (smp) {
        if (smp->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_init_sampler(_sg, smp, &desc_def);
            SOKOL_ASSERT((smp->slot.state == SG_RESOURCESTATE_VALID) || (smp->slot.state == SG_RESOURCESTATE_FAILED));
        } else {
...
SOKOL_API_IMPL void sg_init_shader(_sg_state_t* _sg, sg_shader shd_id, const sg_shader_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    sg_shader_desc desc_def = _sg_shader_desc_defaults(desc);
    _sg_shader_t* shd = _sg_lookup_shader(&_sg->pools, shd_id.id);
    if (shd) {
        if (shd->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_init_shader(_sg, shd, &desc_def);
            SOKOL_ASSERT((shd->slot.state == SG_RESOURCESTATE_VALID) || (shd->slot.state == SG_RESOURCESTATE_FAILED));
        } else {
...
SOKOL_API_IMPL void sg_init_pipeline(_sg_state_t* _sg, sg_pipeline pip_id, const sg_pipeline_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    sg_pipeline_desc desc_def = _sg_pipeline_desc_defaults(_sg, desc);
    _sg_pipeline_t* pip = _sg_lookup_pipeline(&_sg->pools, pip_id.id);
    if (pip) {
        if (pip->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_init_pipeline(_sg, pip, &desc_def);
            SOKOL_ASSERT((pip->slot.state == SG_RESOURCESTATE_VALID) || (pip->slot.state == SG_RESOURCESTATE_FAILED));
        } else {
...
SOKOL_API_IMPL void sg_init_attachments(_sg_state_t* _sg, sg_attachments atts_id, const sg_attachments_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    sg_attachments_desc desc_def = _sg_attachments_desc_defaults(desc);
    _sg_attachments_t* atts = _sg_lookup_attachments(&_sg->pools, atts_id.id);
    if (atts) {
        if (atts->slot.state == SG_RESOURCESTATE_ALLOC) {
            _sg_init_attachments(_sg, atts, &desc_def);
            SOKOL_ASSERT((atts->slot.state == SG_RESOURCESTATE_VALID) || (atts->slot.state == SG_RESOURCESTATE_FAILED));
        } else {
...
SOKOL_API_IMPL void sg_uninit_buffer(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
    if (buf) {
        if ((buf->slot.state == SG_RESOURCESTATE_VALID) || (buf->slot.state == SG_RESOURCESTATE_FAILED)) {
            _sg_uninit_buffer(_sg, buf);
...
SOKOL_API_IMPL void sg_uninit_image(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
        if ((img->slot.state == SG_RESOURCESTATE_VALID) || (img->slot.state == SG_RESOURCESTATE_FAILED)) {
            _sg_uninit_image(_sg, img);
...
SOKOL_API_IMPL void sg_uninit_sampler(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_sampler_t* smp = _sg_lookup_sampler(&_sg->pools, smp_id.id);
    if (smp) {
        if ((smp->slot.state == SG_RESOURCESTATE_VALID) || (smp->slot.state == SG_RESOURCESTATE_FAILED)) {
            _sg_uninit_sampler(_sg, smp);
...
SOKOL_API_IMPL void sg_uninit_shader(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_shader_t* shd = _sg_lookup_shader(&_sg->pools, shd_id.id);
    if (shd) {
        if ((shd->slot.state == SG_RESOURCESTATE_VALID) || (shd->slot.state == SG_RESOURCESTATE_FAILED)) {
            _sg_uninit_shader(_sg, shd);
...
SOKOL_API_IMPL void sg_uninit_pipeline(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_pipeline_t* pip = _sg_lookup_pipeline(&_sg->pools, pip_id.id);
    if (pip) {
        if ((pip->slot.state == SG_RESOURCESTATE_VALID) || (pip->slot.state == SG_RESOURCESTATE_FAILED)) {
            _sg_uninit_pipeline(_sg, pip);
...
SOKOL_API_IMPL void sg_uninit_attachments(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_attachments_t* atts = _sg_lookup_attachments(&_sg->pools, atts_id.id);
    if (atts) {
        if ((atts->slot.state == SG_RESOURCESTATE_VALID) || (atts->slot.state == SG_RESOURCESTATE_FAILED)) {
            _sg_uninit_attachments(_sg, atts);
...
SOKOL_API_IMPL void sg_fail_buffer(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
    if (buf) {
        if (buf->slot.state == SG_RESOURCESTATE_ALLOC) {
...
SOKOL_API_IMPL void sg_fail_image(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
        if (img->slot.state == SG_RESOURCESTATE_ALLOC) {
...
SOKOL_API_IMPL void sg_fail_sampler(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_sampler_t* smp = _sg_lookup_sampler(&_sg->pools, smp_id.id);
    if (smp) {
        if (smp->slot.state == SG_RESOURCESTATE_ALLOC) {
...
SOKOL_API_IMPL void sg_fail_shader(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_shader_t* shd = _sg_lookup_shader(&_sg->pools, shd_id.id);
    if (shd) {
        if (shd->slot.state == SG_RESOURCESTATE_ALLOC) {
...
SOKOL_API_IMPL void sg_fail_pipeline(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_pipeline_t* pip = _sg_lookup_pipeline(&_sg->pools, pip_id.id);
    if (pip) {
        if (pip->slot.state == SG_RESOURCESTATE_ALLOC) {
...
SOKOL_API_IMPL void sg_fail_attachments(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_attachments_t* atts = _sg_lookup_attachments(&_sg->pools, atts_id.id);
    if (atts) {
        if (atts->slot.state == SG_RESOURCESTATE_ALLOC) {
...
SOKOL_API_IMPL sg_resource_state sg_query_buffer_state(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
...
SOKOL_API_IMPL sg_resource_state sg_query_image_state(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
...
SOKOL_API_IMPL sg_resource_state sg_query_sampler_state(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_sampler_t* smp = _sg_lookup_sampler(&_sg->pools, smp_id.id);
...
SOKOL_API_IMPL sg_resource_state sg_query_shader_state(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_shader_t* shd = _sg_lookup_shader(&_sg->pools, shd_id.id);
...
SOKOL_API_IMPL sg_resource_state sg_query_pipeline_state(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_pipeline_t* pip = _sg_lookup_pipeline(&_sg->pools, pip_id.id);
...
SOKOL_API_IMPL sg_resource_state sg_query_attachments_state(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_attachments_t* atts = _sg_lookup_attachments(&_sg->pools, atts_id.id);
...
SOKOL_API_IMPL sg_buffer sg_make_buffer(_sg_state_t* _sg, const sg_buffer_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(desc);
    sg_buffer_desc desc_def = _sg_buffer_desc_defaults(desc);
    sg_buffer buf_id = _sg_alloc_buffer(_sg);
...
SOKOL_API_IMPL sg_image sg_make_image(_sg_state_t* _sg, const sg_image_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(desc);
    sg_image_desc desc_def = _sg_image_desc_defaults(_sg, desc);
    sg_image img_id = _sg_alloc_image(_sg);
...
SOKOL_API_IMPL sg_sampler sg_make_sampler(_sg_state_t* _sg, const sg_sampler_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(desc);
    sg_sampler_desc desc_def = _sg_sampler_desc_defaults(desc);
    sg_sampler smp_id = _sg_alloc_sampler(_sg);
...
SOKOL_API_IMPL sg_shader sg_make_shader(_sg_state_t* _sg, const sg_shader_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(desc);
    sg_shader_desc desc_def = _sg_shader_desc_defaults(desc);
    sg_shader shd_id = _sg_alloc_shader(_sg);
...
SOKOL_API_IMPL sg_pipeline sg_make_pipeline(_sg_state_t* _sg, const sg_pipeline_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(desc);
    sg_pipeline_desc desc_def = _sg_pipeline_desc_defaults(_sg, desc);
    sg_pipeline pip_id = _sg_alloc_pipeline(_sg);
...
SOKOL_API_IMPL sg_attachments sg_make_attachments(_sg_state_t* _sg, const sg_attachments_desc* desc) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(desc);
    sg_attachments_desc desc_def = _sg_attachments_desc_defaults(desc);
    sg_attachments atts_id = _sg_alloc_attachments(_sg);
...
SOKOL_API_IMPL void sg_destroy_buffer(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL void sg_destroy_image(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL void sg_destroy_sampler(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL void sg_destroy_shader(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL void sg_destroy_pipeline(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL void sg_destroy_attachments(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL void sg_begin_pass(_sg_state_t* _sg, const sg_pass* pass) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(!_sg->cur_pass.valid);
    SOKOL_ASSERT(!_sg->cur_pass.in_pass);
    SOKOL_ASSERT(pass);
    SOKOL_ASSERT((pass->_start_canary == 0) && (pass->_end_canary == 0));
    const sg_pass pass_def = _sg_pass_defaults(_sg, pass);
    if (!_sg_validate_begin_pass(_sg, &pass_def)) {
        return;
    }
    ...
    _sg_begin_pass(_sg, &pass_def);
    _SG_TRACE_ARGS(begin_pass, &pass_def);
}

SOKOL_API_IMPL void sg_apply_viewport(_sg_state_t* _sg, int x, int y, int width, int height, bool origin_top_left) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(_sg->cur_pass.in_pass);
    ...
    _sg_apply_viewport(_sg, x, y, width, height, origin_top_left);
    _SG_TRACE_ARGS(apply_viewport, x, y, width, height, origin_top_left);
}

SOKOL_API_IMPL void sg_apply_viewportf(_sg_state_t* _sg, float x, float y, float width, float height, bool origin_top_left) {
    sg_apply_viewport(_sg, (int)x, (int)y, (int)width, (int)height, origin_top_left);
}

SOKOL_API_IMPL void sg_apply_scissor_rect(_sg_state_t* _sg, int x, int y, int width, int height, bool origin_top_left) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(_sg->cur_pass.in_pass);
    ...
    _sg_apply_scissor_rect(_sg, x, y, width, height, origin_top_left);
    _SG_TRACE_ARGS(apply_scissor_rect, x, y, width, height, origin_top_left);
}

SOKOL_API_IMPL void sg_apply_scissor_rectf(_sg_state_t* _sg, float x, float y, float width, float height, bool origin_top_left) {
    sg_apply_scissor_rect(_sg, (int)x, (int)y, (int)width, (int)height, origin_top_left);
}

SOKOL_API_IMPL void sg_apply_pipeline(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(_sg->cur_pass.in_pass);
    _sg_stats_add(num_apply_pipeline, 1);
    if (!_sg_validate_apply_pipeline(_sg, pip_id)) {
...
SOKOL_API_IMPL void sg_apply_bindings(_sg_state_t* _sg, const sg_bindings* bindings) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(_sg->cur_pass.in_pass);
    ...
    if (!_sg_validate_apply_bindings(_sg, bindings)) {
        _sg->next_draw_valid = false;
        return;
    }
    if (!_sg->cur_pass.valid) {
    ...
    if (_sg->next_draw_valid) {
        _sg->next_draw_valid &= _sg_apply_bindings(_sg, &bnd);
        _SG_TRACE_ARGS(apply_bindings, bindings);
    }
}

SOKOL_API_IMPL void sg_apply_uniforms(_sg_state_t* _sg, int ub_slot, const sg_range* data) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(_sg->cur_pass.in_pass);
    SOKOL_ASSERT((ub_slot >= 0) && (ub_slot < SG_MAX_UNIFORMBLOCK_BINDSLOTS));
    SOKOL_ASSERT(data && data->ptr && (data->size > 0));
    ...
    if (!_sg_validate_apply_uniforms(_sg, ub_slot, data)) {
        _sg->next_draw_valid = false;
        return;
    }
    if (!_sg->cur_pass.valid) {
    ...
    _sg_apply_uniforms(_sg, ub_slot, data);
    _SG_TRACE_ARGS(apply_uniforms, ub_slot, data);
}

SOKOL_API_IMPL void sg_draw(_sg_state_t* _sg, int base_element, int num_elements, int num_instances) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(_sg->cur_pass.in_pass);
    ...
    */
    ...
    _sg_draw(_sg, base_element, num_elements, num_instances);
    _SG_TRACE_ARGS(draw, base_element, num_elements, num_instances);
}

SOKOL_API_IMPL void sg_end_pass(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(_sg->cur_pass.in_pass);
...
SOKOL_API_IMPL void sg_commit(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(!_sg->cur_pass.valid);
    SOKOL_ASSERT(!_sg->cur_pass.in_pass);
    _sg_commit(_sg);
    ...
    _sg_notify_commit_listeners(_sg);
    _SG_TRACE_NOARGS(commit);
    _sg->frame_index++;
}

SOKOL_API_IMPL void sg_reset_state_cache(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    _sg_reset_state_cache();
    _SG_TRACE_NOARGS(reset_state_cache);
}

SOKOL_API_IMPL void sg_update_buffer(_sg_state_t* _sg, sg_buffer buf_id, const sg_range* data) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(data && data->ptr && (data->size > 0));
    ...
    if ((data->size > 0) && buf && (buf->slot.state == SG_RESOURCESTATE_VALID)) {
        if (_sg_validate_update_buffer(_sg, buf, data)) {
            ...
            _sg_update_buffer(_sg, buf, data);
...
SOKOL_API_IMPL int sg_append_buffer(_sg_state_t* _sg, sg_buffer buf_id, const sg_range* data) {
    SOKOL_ASSERT(_sg->valid);
    ...
    if (buf) {
        ...
        if (buf->slot.state == SG_RESOURCESTATE_VALID) {
            if (_sg_validate_append_buffer(_sg, buf, data)) {
                if (!buf->cmn.append_overflow && (data->size > 0)) {
                    // update and append on same buffer in same frame not allowed
                    SOKOL_ASSERT(buf->cmn.update_frame_index != _sg->frame_index);
                    _sg_append_buffer(_sg, buf, data, buf->cmn.append_frame_index != _sg->frame_index);
...
SOKOL_API_IMPL bool sg_query_buffer_overflow(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
...
SOKOL_API_IMPL bool sg_query_buffer_will_overflow(_sg_state_t* _sg, sg_buffer buf_id, size_t size) {
    SOKOL_ASSERT(_sg->valid);
    _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
    bool result = false;
    if (buf) {
...
SOKOL_API_IMPL void sg_update_image(_sg_state_t* _sg, sg_image img_id, const sg_image_data* data) {
    SOKOL_ASSERT(_sg->valid);
    ...
    _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img && img->slot.state == SG_RESOURCESTATE_VALID) {
        if (_sg_validate_update_image(_sg, img, data)) {
            SOKOL_ASSERT(img->cmn.upd_frame_index != _sg->frame_index);
            _sg_update_image(_sg, img, data);
...
SOKOL_API_IMPL void sg_push_debug_group(_sg_state_t* _sg, const char* name) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(name);
    _sg_push_debug_group(_sg, name);
    _SG_TRACE_ARGS(push_debug_group, name);
}

SOKOL_API_IMPL void sg_pop_debug_group(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    _sg_pop_debug_group(_sg);
    _SG_TRACE_NOARGS(pop_debug_group);
}

SOKOL_API_IMPL bool sg_add_commit_listener(_sg_state_t* _sg, sg_commit_listener listener) {
    SOKOL_ASSERT(_sg->valid);
    return _sg_add_commit_listener(_sg, &listener);
}

SOKOL_API_IMPL bool sg_remove_commit_listener(_sg_state_t* _sg, sg_commit_listener listener) {
    SOKOL_ASSERT(_sg->valid);
    return _sg_remove_commit_listener(_sg, &listener);
}

SOKOL_API_IMPL void sg_enable_frame_stats(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    _sg->stats_enabled = true;
}

SOKOL_API_IMPL void sg_disable_frame_stats(_sg_state_t* _sg) {
    SOKOL_ASSERT(_sg->valid);
    _sg->stats_enabled = false;
}

SOKOL_API_IMPL bool sg_frame_stats_enabled(_sg_state_t* _sg) {
    return _sg->stats_enabled;
}

SOKOL_API_IMPL sg_buffer_info sg_query_buffer_info(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    sg_buffer_info info;
...
SOKOL_API_IMPL sg_image_info sg_query_image_info(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    sg_image_info info;
    _sg_clear(&info, sizeof(info));
...
SOKOL_API_IMPL sg_sampler_info sg_query_sampler_info(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_shader_info sg_query_shader_info(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
    sg_shader_info info;
    _sg_clear(&info, sizeof(info));
...
SOKOL_API_IMPL sg_pipeline_info sg_query_pipeline_info(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_attachments_info sg_query_attachments_info(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_buffer_desc sg_query_buffer_desc(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    sg_buffer_desc desc;
...
SOKOL_API_IMPL size_t sg_query_buffer_size(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
    if (buf) {
...
SOKOL_API_IMPL sg_buffer_type sg_query_buffer_type(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
    if (buf) {
        return buf->cmn.type;
...
SOKOL_API_IMPL sg_usage sg_query_buffer_usage(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_buffer_t* buf = _sg_lookup_buffer(&_sg->pools, buf_id.id);
    if (buf) {
...
SOKOL_API_IMPL sg_image_desc sg_query_image_desc(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    sg_image_desc desc;
    _sg_clear(&desc, sizeof(desc));
    const _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
...
SOKOL_API_IMPL sg_image_type sg_query_image_type(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
        return img->cmn.type;
...
SOKOL_API_IMPL int sg_query_image_width(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
...
SOKOL_API_IMPL int sg_query_image_height(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
...
SOKOL_API_IMPL int sg_query_image_num_slices(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
...
SOKOL_API_IMPL int sg_query_image_num_mipmaps(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
...
SOKOL_API_IMPL sg_pixel_format sg_query_image_pixelformat(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
...
SOKOL_API_IMPL sg_usage sg_query_image_usage(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    const _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
...
SOKOL_API_IMPL int sg_query_image_sample_count(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
    SOKOL_ASSERT(_sg->valid);
    const _sg_image_t* img = _sg_lookup_image(&_sg->pools, img_id.id);
    if (img) {
...
SOKOL_API_IMPL sg_sampler_desc sg_query_sampler_desc(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_shader_desc sg_query_shader_desc(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
    sg_shader_desc desc;
    _sg_clear(&desc, sizeof(desc));
    const _sg_shader_t* shd = _sg_lookup_shader(&_sg->pools, shd_id.id);
...
SOKOL_API_IMPL sg_pipeline_desc sg_query_pipeline_desc(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_attachments_desc sg_query_attachments_desc(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_buffer_desc sg_query_buffer_defaults(_sg_state_t* _sg, const sg_buffer_desc* desc) {
    SOKOL_ASSERT(_sg->valid && desc);
    return _sg_buffer_desc_defaults(desc);
}

SOKOL_API_IMPL sg_image_desc sg_query_image_defaults(_sg_state_t* _sg, const sg_image_desc* desc) {
    SOKOL_ASSERT(_sg->valid && desc);
    return _sg_image_desc_defaults(_sg, desc);
}

SOKOL_API_IMPL sg_sampler_desc sg_query_sampler_defaults(_sg_state_t* _sg, const sg_sampler_desc* desc) {
    SOKOL_ASSERT(_sg->valid && desc);
    return _sg_sampler_desc_defaults(desc);
}

SOKOL_API_IMPL sg_shader_desc sg_query_shader_defaults(_sg_state_t* _sg, const sg_shader_desc* desc) {
    SOKOL_ASSERT(_sg->valid && desc);
    return _sg_shader_desc_defaults(desc);
}

SOKOL_API_IMPL sg_pipeline_desc sg_query_pipeline_defaults(_sg_state_t* _sg, const sg_pipeline_desc* desc) {
    SOKOL_ASSERT(_sg->valid && desc);
    return _sg_pipeline_desc_defaults(_sg, desc);
}

SOKOL_API_IMPL sg_attachments_desc sg_query_attachments_defaults(_sg_state_t* _sg, const sg_attachments_desc* desc) {
    SOKOL_ASSERT(_sg->valid && desc);
    return _sg_attachments_desc_defaults(desc);
}

SOKOL_API_IMPL const void* sg_d3d11_device(_sg_state_t* _sg) {
    #if defined(SOKOL_D3D11)
...
SOKOL_API_IMPL const void* sg_d3d11_device_context(_sg_state_t* _sg) {
    #if defined(SOKOL_D3D11)
...
SOKOL_API_IMPL sg_d3d11_buffer_info sg_d3d11_query_buffer_info(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_d3d11_image_info sg_d3d11_query_image_info(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_d3d11_sampler_info sg_d3d11_query_sampler_info(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_d3d11_shader_info sg_d3d11_query_shader_info(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_d3d11_pipeline_info sg_d3d11_query_pipeline_info(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_d3d11_attachments_info sg_d3d11_query_attachments_info(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL const void* sg_mtl_device(_sg_state_t* _sg) {
    #if defined(SOKOL_METAL)
...
SOKOL_API_IMPL const void* sg_mtl_render_command_encoder(_sg_state_t* _sg) {
    #if defined(SOKOL_METAL)
        if (nil != _sg->mtl.cmd_encoder) {
...
SOKOL_API_IMPL sg_mtl_buffer_info sg_mtl_query_buffer_info(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_mtl_image_info sg_mtl_query_image_info(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_mtl_sampler_info sg_mtl_query_sampler_info(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_mtl_shader_info sg_mtl_query_shader_info(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_mtl_pipeline_info sg_mtl_query_pipeline_info(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL const void* sg_wgpu_device(_sg_state_t* _sg) {
    #if defined(SOKOL_WGPU)
...
SOKOL_API_IMPL const void* sg_wgpu_queue(_sg_state_t* _sg) {
    #if defined(SOKOL_WGPU)
...
SOKOL_API_IMPL const void* sg_wgpu_command_encoder(_sg_state_t* _sg) {
    #if defined(SOKOL_WGPU)
...
SOKOL_API_IMPL const void* sg_wgpu_render_pass_encoder(_sg_state_t* _sg) {
    #if defined(SOKOL_WGPU)
...
SOKOL_API_IMPL sg_wgpu_buffer_info sg_wgpu_query_buffer_info(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_wgpu_image_info sg_wgpu_query_image_info(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_wgpu_sampler_info sg_wgpu_query_sampler_info(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_wgpu_shader_info sg_wgpu_query_shader_info(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_wgpu_pipeline_info sg_wgpu_query_pipeline_info(_sg_state_t* _sg, sg_pipeline pip_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_wgpu_attachments_info sg_wgpu_query_attachments_info(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_gl_buffer_info sg_gl_query_buffer_info(_sg_state_t* _sg, sg_buffer buf_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_gl_image_info sg_gl_query_image_info(_sg_state_t* _sg, sg_image img_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_gl_sampler_info sg_gl_query_sampler_info(_sg_state_t* _sg, sg_sampler smp_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_gl_shader_info sg_gl_query_shader_info(_sg_state_t* _sg, sg_shader shd_id) {
    SOKOL_ASSERT(_sg->valid);
...
SOKOL_API_IMPL sg_gl_attachments_info sg_gl_query_attachments_info(_sg_state_t* _sg, sg_attachments atts_id) {
    SOKOL_ASSERT(_sg->valid);
